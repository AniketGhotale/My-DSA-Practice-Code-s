...
public class GraphQuestions {
    ...
    public static int chepestFlightwithKstops(int points[][],int src, int dest, int k){
        int n = points.length; 
    ...
    public static void topologicalSort(ArrayList<Edge> graph[]){
        ...
        boolean visitedd[] = new boolean[transpose.length];
        while (!s.isEmpty()) {
            int curr = s.pop();
            if(!visitedd[curr]){
                System.out.print("SCC -> ");
                dfsforSCC(transpose, visitedd, curr);
                System.out.println();
            }
    ...
    public static void dfsforSCC(ArrayList<Edge> graph[], boolean visited[],int curr){
        System.out.print(curr + " ");
        visited[curr] = true;
        for(int i=0; i<graph[curr].size(); i++){
            Edge e = graph[curr].get(i);
    ...
    public static void topologicalSortutil(ArrayList<Edge> graph[],int curr,boolean visited[],Stack<Integer> s){ //dfs
        visited[curr] = true;
        for(int i=0; i<graph[curr].size(); i++){
            Edge e = graph[curr].get(i);
            if(!visited[e.dest]){
    ...
    public static void main(String args[]){
        ...
        // primsAlgo(graph1);
        // System.out.println();
        // System.out.print("Cheapest Flight within K stops :- ");
        // System.out.print(chepestFlightwithKstops(pints, 0, 1, 0));
        System.out.println();
        System.out.println("Strongly Connected Componente's = ");
